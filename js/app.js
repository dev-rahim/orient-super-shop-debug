...
const showProducts = (products) => {
    ...
    <div class="card">
    <img class="product-image card-img-top img-cap img-cap" src=${image}></img>
    <div class="card-body">
...
const getProductDetails = (id) => {
    ...
    fetch(`https://fakestoreapi.com/products/${id}`).then(res => res.json()).then(data => showDetails(data))
